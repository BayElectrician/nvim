...
-- Running the current Python file in a new terminal window
vim.keymap.set("n", "<leader>p", ':term python "%:p" <return> i', { desc = "Run Current [P]ython files" })
